    ...
    if (stateNotifierProvider != null ||
      ...
      ref.listen(stateNotifierProvider ?? stateNotifierAutoDisposeProvider!,
        ...
        if (errorExtractor != null) {
          error = errorExtractor!(value);
        } else {
          error = _defaultErrorExtractor(value);
        }
        if (old != null) {
          if (errorExtractor != null) {
            oldError = errorExtractor!(old);
          } else {
            oldError = _defaultErrorExtractor(old);
          }
        }
        ...
        if (infoExtractor != null) {
          info = infoExtractor!(value);
        } else {
          info = _defaultInfoExtractor(value);
        }
        if (old != null) {
          if (infoExtractor != null) {
            oldInfo = infoExtractor!(old);
          } else {
            oldInfo = _defaultInfoExtractor(old);
          }
        }
