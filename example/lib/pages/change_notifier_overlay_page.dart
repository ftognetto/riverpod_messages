...
class ChangeNotifierOverlayPage extends ConsumerWidget {
  const ChangeNotifierOverlayPage({Key? key}) : super(key: key);
        ...
        body: MessageOverlayListener(
            ...
            child: Center(
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    ref
                        .read(exampleChangeNotifierProvider.notifier)
                        .simulateError();
                  }),
              ElevatedButton(
              ...
              ref.watch(exampleChangeNotifierProvider.select((value) => value.loading)) ? const CircularProgressIndicator() : Container()
            ]))));
  }
}
